...
| [S15](09-example-domain.md) | Domínio de exemplo realista `varejo` | D1 | `scripts/fixtures/varejo/**`, `fixtures/dbt-source/varejo/**`, `cypress/fixtures/data/varejo/**`, `cypress/e2e/varejo-smoke.cy.ts`, `package.json` (só o script) |
